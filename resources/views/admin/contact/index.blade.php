                        ...
                        <tbody>
                            @foreach($contacts as $key=>$contact)
                                <tr>
                                    ...
                                    <td>
                                        <div class="widget-heading">{{ $contact->subject }}</div>
                                    </td>
                                    <td>
                                        <div class="widget-heading">{{ $contact->type }}</div>
                                    </td>
                                    <td class="text-left">
                                        <a class="btn btn-info btn-sm" href="{{ route('admin.contact.edit',$contact->id) }}"><i
                                                class="fas fa-edit"></i>
                                            <span>Edit</span>
                                        </a>
